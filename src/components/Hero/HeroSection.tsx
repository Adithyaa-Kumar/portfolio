...
═══════════════════════════════════════════════════════════════
  ...
  HeroSection.tsx — v4 + ENTER SYSTEM TRANSITION

  NEW: onEnter prop wired to ENTER SYSTEM button.
  Click sequence:
    1. Button scale-press (spring back)
    2. White flash burst
    3. Section glitch-exit (skewX + opacity → 0)
    4. onEnter() called → parent swaps to dashboard

  Everything else preserved from v4:
    Boot sequence, wire blink (opacity only, no red),
    glitch slice, portrait dual-layer stroke effect,
    mouse parallax, signal corruption, grain, grid.

═══════════════════════════════════════════════════════════════
*/

type LineType = "ok" | "warn" | "err" | "dim" | "bright" | "gap";
...
const BOOT_LINES: { text: string; type: LineType }[] = [
  ...
  { text: "Copyright (C) ADITHYAA K — All Rights Reserved",             type: "dim"    },
  { text: "",                                                            type: "gap"    },
  ...
  { text: "   [  OK  ]  cinematic_renderer.ko        loaded",            type: "ok"    },
  ...
  { text: "   ENGINEER ..... ADITHYAA K                    [VERIFIED]",  type: "ok"    },
  { text: "   ROLE ......... AI ENGINEER                    [ACTIVE]",   type: "ok"    },
  { text: "   PORTFOLIO .... CINEMATIC ENGINE v4             [READY]",   type: "ok"    },
  { text: "",                                                            type: "gap"    },
  { text: "▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓ 100%",             type: "bright" },
  { text: "BOOT COMPLETE — INITIALIZING VISUAL ENVIRONMENT",             type: "bright" },
];
...
export default function HeroSection({ onEnter }: HeroSectionProps) {
  ...
  const runBoot = () => {
    ...
    const D: Record<LineType,number> = { ok:80, warn:125, err:140, dim:60, bright:100, gap:40 };
    ...
    tl.call(() => {
      ...
      gsap.to(portRef.current, { keyframes:[
        ...
        <div style={{ display:"flex", flexDirection:"column", gap:"1.5px", maxHeight:"70vh", overflow:"hidden" }}>
          {bootLines.map((line, i) => {
            const c: Record<LineType,string> = {
              ...
              dim:"rgba(255,255,255,0.26)", bright:"rgba(255,255,255,0.97)", gap:"transparent",
            };
            return (
      ...
      <div ref={mainRef} style={{
        ...
        <div ref={leftRef} style={{
          ...
          <div style={{
            ...
            fontFamily:"var(--font-orbitron)", fontSize:"clamp(6rem,13vw,16rem)", lineHeight:0.82,
          ...
          <div ref={sysLabelRef} style={{
            ...
            fontSize:"0.45rem", letterSpacing:"0.58em", color:"rgba(255,255,255,0.22)",
          ...
          <div ref={nameRef} style={{ position:"relative", userSelect:"none", opacity:0 }}>
            ...
            <div style={{
              ...
              color:"rgba(255,255,255,0.95)", display:"flex", flexWrap:"wrap",
          ...
          {/* Divider */}
          <div ref={divRef} style={{ width:"90px", height:"1px", background:"rgba(255,255,255,0.16)", marginTop:"2rem", marginBottom:"2rem" }}/>
          ...
          {/* Tagline */}
          <p ref={tagRef} style={{
            maxWidth:"320px", fontFamily:"var(--font-rajdhani)",
          ...
          >
            Designing cinematic AI systems, intelligent automation environments,
            immersive interfaces, and operational digital experiences through engineering precision.
          </p>
  ...
  ENTER SYSTEM →
        ...
        <div ref={rightRef} style={{
          ...
          <div style={{
            ...
            fontFamily:"var(--font-mono)", fontSize:"0.35rem", letterSpacing:"0.36em", color:"rgba(255,255,255,0.1)",
          }}>
            AK/OS v3.1.4 // BUILD 20260515
          </div>
        </div>
      </div>
...
function LiveClock() {
  ...
  return <div style={{ position:"absolute", top:"14px", right:"24px", fontFamily:"var(--font-mono)", fontSize:"0.4rem", letterSpacing:"0.3em", color:"rgba(255,255,255,0.28)" }}>{t}</div>;
}